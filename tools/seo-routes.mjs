...
export const prefPath = (pref) => PREF_SLUG[pref] ? '/area/' + PREF_SLUG[pref] + '.html' : '/area.html';
export const brandPath = (brand) => BRAND_SLUG[brand]
  ? '/brand/' + BRAND_SLUG[brand] + '.html'
  : '/stores.html?q=' + encodeURIComponent(brand);
